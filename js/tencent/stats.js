(function (b) {
    ...
    MtaH5.hack = function () {
        ...
        0 < b.length && function () {
            ...
            "undefined" !== typeof b[0].attributes.cid && (f.conf.cid = b[0].attributes.cid.nodeValue);
...
(function (b, t) {
    ...
    function z(a) {
        ...
        if (b.sid)if (!b.userReport || b.user.user_id && !parseInt(b.user.user_id, 10) !== b.user.user_id) {
            a = [];
            for (var c = 0, e = [u(), x(), {r2: b.sid}, v(), w({version: b.version}), {random: +new Date}],
                     h = e.length; c < h; c++)for (d in e[c])e[c].hasOwnProperty(d) && a.push(d + "=" + ("undefined" == typeof e[c][d] ? "" : e[c][d]));
            var g = function (a) {
            ...
            b.performanceMonitor && (d = function () {
                if (window.performance) {
                    ...
                    var d = {value: a.connectEnd - a.connectStart}, e = {value: a.responseStart - (a.requestStart || a.responseStart + 1)}, n = a.responseEnd - a.responseStart;
    ...
    Ta.clickStat = MtaH5.clickStat = function (a, d) {
        ...
        if (e.cid) {
            ...
            for (f = g.length; m < f; m++)for (var l in g[m])g[m].hasOwnProperty(l) && h.push(l + "=" + ("undefined" == typeof g[m][l] ? "" :
                    g[m][l]));
            h = MtaH5.src = ("https:" == document.location.protocol ? "https://pingtas.qq.com/webview" : "http://pingtcss.qq.com") + "/pingd?" + h.join("&").toLowerCase();
            var k = new Image;
